...
static void private_layout(LIFntLayout* self);

static int private_get_line_height(LIFntLayout* self,
								   int          start,
								   int          end);

static int private_get_line_ascent(LIFntLayout* self,
								   int          start,
								   int          end);

static int private_get_line_width(LIFntLayout* self,
								  int          start,
								  int*         end);
