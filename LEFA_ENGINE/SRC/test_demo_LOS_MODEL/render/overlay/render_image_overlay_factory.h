...
#ifndef __RENDER_INTERNAL_IMAGE_OVERLAY_FACTORY_H__
#define __RENDER_INTERNAL_IMAGE_OVERLAY_FACTORY_H__
/*
...
typedef struct _LIRenImageOverlayFactory LIRenImageOverlayFactory;
struct _LIRenImageOverlayFactory 
{
