 ...
 * \param self DDS.
 */
static void liimg_dds_byteswap (
	LIImgDDS* self)
{
	if (lisys_endian_big ())
	{
 ...
 */
static int liimg_dds_read_header (
	LIImgDDS* self,
	FILE*     file)
{
	int i;
 ...
 * \return Nonzero on success.
 */
static int liimg_dds_read_level(
	LIImgDDS*      self,
	FILE*          file,
	int            level,
 ...
 * \return Nonzero on success.
 */
static int liimg_dds_write_header(
	LIImgDDS* self,
	FILE*     file)
{
	liimg_dds_byteswap (self);
 ...
 */
static 
int liimg_dds_write_level(LIImgDDS* self,
										FILE*     file,
										int       level,
										void*     data,
										int       size)
