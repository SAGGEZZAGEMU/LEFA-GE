...
typedef unsigned char LIMdlVertexColor;
typedef unsigned char LIMdlVertexBone;
...
static inline 
void limdl_vertex_init(LIMdlVertex*  self,
					   const vec3*   coord,
					   const vec3*   normal,
					   float         u,
					   float         v)
...
static inline 
void limdl_vertex_init_copy(LIMdlVertex*       self,
...
static inline 
int limdl_vertex_compare(const LIMdlVertex* self,
						 const LIMdlVertex* vertex)
{
...
static inline 
void limdl_vertex_round(LIMdlVertex* self)
{
