...
LIAPICALL (void*, lialg_octree_get_data_point, (LIAlgOctree* self,const vec3* point));

LIAPICALL (int, lialg_octree_set_data_point, (LIAlgOctree* self, const vec3* point, void* data));

LIAPICALL (int, lialg_octree_get_size, (const LIAlgOctree* self));
