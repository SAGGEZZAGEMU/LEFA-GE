 ...
 */
static inline vec3
limat_matrix_transform (mat4 self,
                        vec3 vector)
{
	vec3 result;
...
static inline vec3
limat_matrix_get_basis (const mat4 self,
                        int               basis)
{
	switch (basis)
	{
...
static inline mat4
limat_matrix_get_rotation(const mat4 self)
{
	mat4 result;
...
static inline int
limat_matrix_get_singular (const mat4 self)
{
	float det;
...
/* Stolen from Mesa. */
static inline mat4
limat_matrix_invert (const mat4 self)
{
	int i;
	float det;
	float inv[16];
...
static inline mat4
limat_matrix_multiply (const mat4 self,
                       const mat4 matrix)
{
	mat4 result;
 ...
 */
static inline int
limat_matrix_project (const mat4  projection,
 ...
 */
static inline int
limat_matrix_unproject (const mat4  projection,
                        const mat4  modelview,
                        const int*         viewport,
                        const vec3* window,
                        vec3*       object)
