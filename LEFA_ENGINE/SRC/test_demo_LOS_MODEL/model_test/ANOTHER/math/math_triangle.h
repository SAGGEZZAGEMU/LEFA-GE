 ...
 */
static inline int
limat_triangle_intersects_point (const vec3* vertex0,
                                 const vec3* vertex1,
                                 const vec3* vertex2,
                                 const vec3* point)
{
...
*/
	    // Inicializa individualmente cada plano com os valores apropriados
    p[0].x = 1; p[0].y = 0; p[0].z = 0; p[0].w = x0; // Left
    p[1].x = 1; p[1].y = 0; p[1].z = 0; p[1].w = x1; // Right
    p[2].x = 0; p[2].y = 1; p[2].z = 0; p[2].w = y0; // Bottom
    p[3].x = 0; p[3].y = 1; p[3].z = 0; p[3].w = y1; // Top
    p[4].x = 0; p[4].y = 0; p[4].z = 1; p[4].w = z0; // Front
    p[5].x = 0; p[5].y = 0; p[5].z = 1; p[5].w = z1; // Back
...
*/
	// Inicializa individualmente cada retângulo com os valores apropriados
	r[0].x = y0; r[0].y = z0; r[0].width = size->y; r[0].height = size->z; // Left and right.
	r[1].x = x0; r[1].y = z0; r[1].width = size->x; r[1].height = size->z; // Bottom and top.
	r[2].x = x0; r[2].y = y0; r[2].width = size->x; r[2].height = size->y; // Front and back.
