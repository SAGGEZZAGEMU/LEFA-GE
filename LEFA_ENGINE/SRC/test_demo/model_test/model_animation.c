...
void private_frame_transform(LIMdlAnimation* self,
							 int chan,
							 int frame,
							 float* scale,
							 LIMatTransform* value);

static int private_read(LIMdlAnimation* self, LIArcReader* reader);
 ...
 * \return New animation.
 */
LIMdlAnimation* limdl_animation_new_copy(const LIMdlAnimation* anim)
{
	LIMdlAnimation* self;
 ...
 */
LIMdlAnimation* limdl_animation_new_from_data(LIArcReader* reader)
{
	LIMdlAnimation* self;
 ...
 * \return New animation, or NULL.
 */
LIMdlAnimation* limdl_animation_new_from_file(const char* path)
{
	LIArcReader* reader;
	LIMdlAnimation* self;
 ...
 */
int limdl_animation_init_copy(LIMdlAnimation* self,
 ...
 * \param self Animation.
 */
void limdl_animation_free(LIMdlAnimation* self)
{
 ...
 * \return Nonzero on success.
 */
int limdl_animation_insert_channel(LIMdlAnimation* self,
								   const char* name)
{
	int chan;
	int frame;
 ...
 */
int limdl_animation_get_channel(LIMdlAnimation* self,
								const char* name)
{
	int i;
 ...
 */
float limdl_animation_get_duration(const LIMdlAnimation* self)
{
	if(self->length > 1)
 ...
 */
int limdl_animation_get_length(const LIMdlAnimation* self)
{
 ...
 * \return Nonzero on success.
 */
int limdl_animation_set_length(LIMdlAnimation* self,
							   int value)
{
	int i;
	LIMdlFrame* tmp;
...
int private_read(LIMdlAnimation* self,
				 LIArcReader* reader)
{
	int ret;
	char* id;
