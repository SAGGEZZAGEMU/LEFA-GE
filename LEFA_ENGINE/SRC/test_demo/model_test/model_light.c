 ...
 */
int limdl_light_read(LIMdlNode*   self,
					 LIArcReader* reader)
{
	uint32_t tmp;
 ...
 * \return Nonzero on success.
 */
int limdl_light_write(const LIMdlNode* self,
					  LIArcWriter*     writer)
{
 ...
 */
void limdl_light_get_modelview(const LIMdlNode* self, mat4* value)
{
 ...
 * \param value Return location for the matrix.
 */
void limdl_light_get_projection(const LIMdlNode* self,
								mat4* value)
{
