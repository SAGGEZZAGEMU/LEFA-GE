 ...
 */
int limdl_material_init(LIMdlMaterial* self)
{
 ...
 * \return Nonzero on success.
 */
int limdl_material_init_copy(LIMdlMaterial*       self,
 ...
 * \param self Material.
 */
void limdl_material_free(LIMdlMaterial* self)
{
...
int limdl_material_append_texture(LIMdlMaterial* self,
								  int            type,
								  int            flags,
								  const char*    name)
{
 ...
 * \param self Material.
 */
void limdl_material_clear_textures(LIMdlMaterial* self)
{
	int i;
 ...
 */
int limdl_material_compare(const LIMdlMaterial* self,
