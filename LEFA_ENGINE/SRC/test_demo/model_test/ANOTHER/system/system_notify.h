...
LIAPICALL(void, lisys_notify_free, (LISysNotify* self));

LIAPICALL(int, lisys_notify_add, (LISysNotify*     self,
								  const char*      path,
								  LISysNotifyFlags flags));

LIAPICALL(void, lisys_notify_remove, (LISysNotify* self,
									  const char*  path));

LIAPICALL(LISysNotifyEvent*, lisys_notify_poll, (LISysNotify* self));

LIAPICALL(LISysNotifyEvent*, lisys_notify_wait, (LISysNotify* self));
