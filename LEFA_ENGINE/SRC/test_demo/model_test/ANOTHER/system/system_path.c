 ...
 */
char* lisys_path_basename(const char* path)
{
	char* ptr;
 ...
 */
int lisys_path_check_ext(const char* path,
						 const char* ext)
{
	int plen;
	int elen;
 ...
 */
char* lisys_path_concat(const char* path, ...)
{
	int len;
	int total;
	char last;
 ...
 */
char* lisys_path_format(lisysPathFormat format, ...)
{
	int cap;
	int len;
	int pos;
 ...
 * \return New string or NULL.
 */
char* lisys_path_filename(const char* path)
{
	const char* ptr;
 ...
 * \return New string or NULL.
 */
char* lisys_path_fileext(const char* path)
{
	const char* ptr0;
	const char* ptr1;
 ...
 * \return New string or NULL.
 */
char* lisys_path_pathname(const char* path)
{
	char* ret;
	const char* ptr;
